...
namespace WebApi2TaskManagement.Web.Common
{
    public class NamespaceHttpControllerSelector : IHttpControllerSelector
    {
        ...
        private string GetControllerName(IHttpRouteData routeData)
        {
            ...
            var controllerName = ((HttpActionDescriptor[])dataTokenValue).
                First().ControllerDescriptor.ControllerName.Replace("Controller", string.Empty);
